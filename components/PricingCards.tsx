  ...
  return (
    <div>
        <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
            {
                tiers.map((tier) => (
                    <div key={tier.id} className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-xl ring-1 ring-gray-900/50 sm:p-10">
                        <div>
                        ...
                        {redirect ? (
                            <Link href="/register" className="bg-indigo-600 px-3.5 py-2 rounded-md mt-8 block text-white shadow-sm text-center hover:bg-indigo-500">Get Started Today</Link>
                        ) : (
